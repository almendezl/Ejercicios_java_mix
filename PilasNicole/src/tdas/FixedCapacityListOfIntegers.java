 ...
 */
public class FixedCapacityListOfIntegers { //Lista que almacena numeros enteros 
   ...
   /* public boolean igualdades(Integer p) {
    ...
    //cuantos elementos hay, el tamaño de la lista es diferente al arreglo, es solo los elementos que hay 
    ...
    public String mostrar() {
        String salida = "Tamaño actual  " + contador + "\n";
        for (Integer p : lista) {
            salida += p + "\n";
        }
        return salida;
