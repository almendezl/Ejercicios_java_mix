...
//----------------------------------------Rotaciones-----------------------------------------------------------
	...
	public void hor(int disco) {
		...
		cubos[disco][1][0] = aux;
		//Rotacion Cubos
		cubos[disco][0][0].hor(); cubos[disco][0][1].hor();
		cubos[disco][1][1].hor(); cubos[disco][1][0].hor();
		//Generar nueva clave
		generadorKey();
	}
	...
	public void ver(int disco) {
		...
		cubos[1][disco][0] = aux;
		//Rotacion Cubos
		cubos[0][disco][0].ver(); cubos[0][disco][1].ver();
		cubos[1][disco][1].ver(); cubos[1][disco][0].ver();
		//Generar nueva clave
		generadorKey();
	}
	...
	public void tra(int disco) {
		...
		cubos[0][1][disco] = aux;
		//Rotacion Cubos
		cubos[0][0][disco].tra(); cubos[1][0][disco].tra();
		cubos[1][1][disco].tra(); cubos[0][1][disco].tra();
		//Generar nueva clave
		generadorKey();
	}
//----------------------------------------Movimientos Negativos--------------------------------------------
	...
	public void nHor(int disco) {
		hor(disco); hor(disco); hor(disco);
	}
	
	public void nVer(int disco) {
		ver(disco); ver(disco); ver(disco);
	}
	
	public void nTra(int disco) {
		tra(disco); tra(disco); tra(disco);
	}
