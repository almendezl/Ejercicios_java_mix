 ...
 */
 ...
 /**
   ...
   */	
     public Color getIzquierda( ) { return this.izquierda; }
     
 /**
  * Cambia el color de la cara
  * @param izq 
  */     
     public void setIzquierda(Color izq) { this.izquierda = izq; } 	
     
 /**
   * Devuelve el color de la cara frontal
   * @return Color de la cara frontal
   */	
     public Color getFrontal( ) { return this.frontal; }

 /**
  * Cambia el color de la cara
  * @param fro 
  */          
     public void setFrontal(Color fro) { this.frontal = fro; }

  /**
   * Devuelve el color de la cara derecha
   * @return Color de la cara derecha
   */	
     public Color getDerecha( ) { return this.derecha; }

 /**
  * Cambia el color de la cara
  * @param der 
  */          
     public void setDerecha(Color der) { this.derecha = der; }
 ...
 /**
   ...
   */	
     public Color getPosterior( ) { return this.posterior; }

 /**
  * Cambia el color de la cara
  * @param pos 
  */          
     public void setPosterior(Color pos) { this.posterior = pos; }
 ...
 /**
   ...
   */	
     public Color getSuperior( ) { return this.superior; }

 /**
  * Cambia el color de la cara
  * @param sup 
  */          
     public void setSuperior(Color sup) { this.superior = sup; }
 ...
 /**
   ...
   */	
     public Color getInferior( ) { return this.inferior; }

 /**
  * Cambia el color de la cara
  * @param inf 
  */          
     public void setInferior(Color inf) { this.inferior = inf; }
 ...
 /**
   ...
   * Las caras afectadas son: Frontal, Izquierda, Posterior y Derecha.
   * La cara Inferior gira en su eje, como las manecillas del reloj.
   * La cara Superior gira en su eje, en forma contraria.
   */	   
     public void horizontal( )
     { Color aux;
       aux = frontal; frontal = izquierda; izquierda = posterior;
       posterior = derecha; derecha = aux;
     }

 /**
   * Realiza un corrimiento de los colores de las caras, verticalmente.
   * Las caras afectadas son: Frontal, Superior, Posterior e inferior.
   * La cara Izquierda gira en su eje, como las manecillas del reloj.
   * La cara Derecha gira en su eje, en forma contraria.
   */	   
     public void vertical( )
     { Color aux;
       aux = frontal; frontal = superior; superior = posterior;
       posterior = inferior; inferior = aux;
     }

 /**
   * Realiza un corrimiento de los colores de las caras, transversalmente.
   * Las caras afectadas son: Superior, Izquierda, Inferior y Derecha.
   * La cara Frontal gira en su eje, como las manecillas del reloj.
   * La cara  Posterior gira en su eje, en forma contraria.
   */	   
     public void transversal( )
     { Color aux;
       aux = superior; superior = izquierda; izquierda = inferior;
       inferior = derecha; derecha = aux;
     }       

    @Override
    public String toString() {
        return "Cube{" + "izquierda=" + izquierda.toString() + ", frontal=" + frontal.toString() + ", derecha=" + derecha.toString() + ", posterior=" + posterior.toString() + ", superior=" + superior.toString() + ", inferior=" + inferior.toString() + '}';
    }
