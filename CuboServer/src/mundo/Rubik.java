...
public String generadorKey() {
    String key="";
    //rojo
                key += verificarc(ernoRubik[0][0][0].getIzquierda())+""+ verificarc(ernoRubik[0][0][1].getIzquierda())+""+ verificarc(ernoRubik[1][0][0].getIzquierda())+""+ verificarc(ernoRubik[1][0][1].getIzquierda())+"";
		//azul
                key += verificarc(ernoRubik[0][0][0].getFrontal())+""+ verificarc(ernoRubik[0][1][0].getFrontal())+"" + verificarc(ernoRubik[1][0][0].getFrontal())+""+ verificarc(ernoRubik[1][1][0].getFrontal())+"";
		//naranja
                key += verificarc(ernoRubik[0][1][0].getDerecha())+""+ verificarc(ernoRubik[0][1][1].getDerecha())+""+ verificarc(ernoRubik[1][1][0].getDerecha())+""+ verificarc(ernoRubik[1][1][1].getDerecha())+"";
		//verde
                key += verificarc(ernoRubik[0][0][1].getPosterior())+""+ verificarc(ernoRubik[0][1][1].getPosterior())+""+ verificarc(ernoRubik[1][0][1].getPosterior())+""+ verificarc(ernoRubik[1][1][1].getPosterior())+"";
		//blanco
		key += verificarc(ernoRubik[0][0][0].getSuperior())+""+ verificarc(ernoRubik[0][0][1].getSuperior())+""+ verificarc(ernoRubik[0][1][0].getSuperior())+""+ verificarc(ernoRubik[0][1][1].getSuperior())+"";
		//amarillo
                key += verificarc(ernoRubik[1][0][0].getInferior())+""+verificarc(ernoRubik[1][0][1].getInferior())+""+verificarc(ernoRubik[1][1][0].getInferior())+""+verificarc(ernoRubik[1][1][1].getInferior());	
    ...
    public String toString() {
        return "Rubik{" + "ernoRubik=" + ernoRubik.toString() + generadorKey() +'}';
    }
