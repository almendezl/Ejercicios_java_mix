...
public Hashtable getHashRubik() {
	return hashRubik;
}

public void setHashRubik(Hashtable hashRubik) {
	this.hashRubik = hashRubik;
}

public ArrayList<Actions> getLstSolve() {
	return lstSolve;
}

public void setLstSolve(ArrayList<Actions> lstSolve) {
	this.lstSolve = lstSolve;
}
...
public int getIdxChild() {
	return idxChild;
}

public void setIdxChild(int idxChild) {
	this.idxChild = idxChild;
}
